...
defmodule Ex04 do
  ...
  def even_odd_check(head, {even, odd}) when Integer.is_even(head), do: {even ++ [head], odd}
  def even_odd_check(head, {even, odd}) when Integer.is_odd(head), do: {even, odd ++ [head]}
  def even_odd(list), do: reduce list, {[], []}, &even_odd_check/2
